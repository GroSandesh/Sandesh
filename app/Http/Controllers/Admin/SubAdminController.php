...
class SubAdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            ...
            'acc_id'        => strtoupper(substr($request['fname'], 0, 2)."-".rand(1111,9999)),
        ]);
        ...
        return redirect()->route('admin.subadmin.index')->with('Success','Subadmin Created Successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'mobile'        => 'required|numeric|digits_between:8,11|unique:users,id',
            'address'       => 'required|min:8|max:255',
        ]);
